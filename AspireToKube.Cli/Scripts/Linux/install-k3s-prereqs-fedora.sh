...
# Prerequisites Installation Script for Fedora
...
echo -e "  • SELinux is enabled by default - k3s-selinux policy installed automatically"
...
echo -e "  • Check logs: ${CYAN}journalctl -u k3s -f${NC}"

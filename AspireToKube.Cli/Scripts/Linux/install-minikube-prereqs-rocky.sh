...
# Prerequisites Installation Script for Rocky Linux / RHEL - Minikube Edition
...
echo -e "  • SELinux is typically enabled - monitor for permission issues"
echo -e "  • Docker repository uses CentOS compatibility"
